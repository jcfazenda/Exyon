...
CREATE TABLE `usuario_empresa` (
  `idUsuarioEmpresa` bigint(9) unsigned NOT NULL AUTO_INCREMENT,
  `idUsuario` bigint(9) DEFAULT NULL,
  `idStatus` bigint(9) DEFAULT NULL,
  `idCentroCusto` bigint(9) DEFAULT NULL,
  `idEmpresa` bigint(9) DEFAULT NULL,
...
INSERT INTO `usuario_empresa` VALUES (1,1,1,1,1),(2,2,1,1,1),(3,3,1,2,1),(5,11,1,0,1),(6,12,1,0,1);
